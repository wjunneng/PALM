...
def res_evaluate(res_dir="", eval_phase=""):
    if eval_phase == 'test':
        data_dir = os.path.join(PATH.OUTPUT_ENTITY_TYPE_DIR, 'test.tsv')
    elif eval_phase == 'dev':
        data_dir = os.path.join(PATH.OUTPUT_ENTITY_TYPE_DIR, 'dev.tsv')
    else:
...
predictions_test_json_path = os.path.join(PATH.OUTPUT_ENTITY_TYPE_DIR, 'predictions_test.json')
predictions_dev_json_path = os.path.join(PATH.OUTPUT_ENTITY_TYPE_DIR, 'predictions_dev.json')
