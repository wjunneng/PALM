...
from examples.entity_linking.core.evaluate_entity_type import res_evaluate
...
if __name__ == '__main__':
    ...
    dev_file = os.path.join(PATH.OUTPUT_ENTITY_TYPE_DIR, 'dev.tsv')
    ...
    for step, batch in enumerate(iterator, start=1):
        ...
        if step % (n_steps // 10) == 0:
            # -----------------------  for evaluation -----------------------
            print('do evaluation...', flush=True)
            # step 1-1: create readers for training
            ...
            # dev_num_examples: 33074 dev_print_steps: 33
